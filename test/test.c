...
void	test_substr()
{
	...
	res = ft_substr(str1, 0, 5);
	assert(!strcmp(res, "Hello"));
	free(res);
	res = ft_substr(str1, 2, SIZE_MAX / 2);
	assert(!strcmp(res, str1 + 2));
	free(res);
	res = ft_substr(str1, 0, 0);
	assert(!strcmp(res, ""));
	free(res);
	res = ft_substr(str1, 20, 0);
	assert(!strcmp(res, ""));
	free(res);
	res = ft_substr(str1, 20, 20);
	assert(!strcmp(res, ""));
	free(res);
	res = ft_substr(str2, 0, 5);
	assert(!strcmp(res, ""));
	free(res);
	res = ft_substr(str2, 2, SIZE_MAX / 2);
	assert(!strcmp(res, ""));
	free(res);
	res = ft_substr(str2, 0, 0);
	assert(!strcmp(res, ""));
	free(res);
	res = ft_substr(str2, 20, 0);
	assert(!strcmp(res, ""));
	free(res);
	res = ft_substr(str2, 20, 20);
	assert(!strcmp(res, ""));
	free(res);
}
